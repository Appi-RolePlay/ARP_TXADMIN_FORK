...
import { BoxIcon, ChevronRightSquareIcon, DnaIcon, EyeIcon, FileEditIcon, HourglassIcon, LayoutDashboardIcon, SlidersHorizontalIcon } from 'lucide-react';
    ...
    return <div className='relative'>
        ...
        <div className={cn(isConfigPending && 'opacity-0 pointer-events-none')}>
            ...
            <div className="space-y-1 select-none">
                ...
                <MenuNavLink href="/server/arp-config" disabled={!hasPerm('arp.config')}>
                    <SlidersHorizontalIcon className="mr-2 h-4 w-4" />Game Config
                </MenuNavLink>
